...
describe SearchMethods::DiagonalDown do
  let(:wordgrid) {
    [
  ...
  let(:subject) { SearchMethods::DiagonalDown.new(wordgrid) }

  context "initialization" do
    it "should load the word grid in the right format" do
      expect(subject.grid).to eq(wordgrid_modified.transpose)
    end
  end
